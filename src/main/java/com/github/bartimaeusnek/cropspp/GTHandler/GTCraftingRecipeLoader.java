...
public class GTCraftingRecipeLoader implements Runnable {
    ...
    public void run() {
        ...
        GT_ModHandler.addCraftingRecipe(CropItemList.cropGeneExtractorMV.get(1L), bitsd, new Object[]{"RTR", aTextWireHull, "CRC", 'M', ItemList.Hull_MV, 'T', ItemList.Emitter_MV, 'R', ItemList.Sensor_MV, 'C', OrePrefixes.circuit.get(Materials.Advanced), 'W', OrePrefixes.cableGt01.get(Materials.Copper)});
        ...
        GT_ModHandler.addCraftingRecipe(CropItemList.cropReplicatorMV.get(1L), bitsd, new Object[]{"CFC", aTextCableHull, aTextMotorWire, 'M', ItemList.Hull_MV, 'F', ItemList.Field_Generator_MV, 'E', ItemList.Emitter_MV, 'C', OrePrefixes.circuit.get(Materials.Advanced), 'W', OrePrefixes.cableGt04.get(Materials.Copper)});
        ...
        GT_ModHandler.addCraftingRecipe(CropItemList.cropSynthesiserMV.get(1L), bitsd, new Object[]{"FCF", aTextCableHull, "EEE", 'M', ItemList.Hull_MV, 'F', ItemList.Field_Generator_MV, 'E', ItemList.Emitter_MV, 'C', OrePrefixes.circuit.get(Materials.Advanced), 'W', OrePrefixes.cableGt04.get(Materials.Copper)});
